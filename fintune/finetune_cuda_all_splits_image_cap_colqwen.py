...
# load json file
json_data_path = "/home/linux/yyj/colpali/finetune/mmlm-rag/utils/all_splits_image_cap_pairs.json"
ds = load_dataset("json", data_files=json_data_path, split="train")

# load images
image_dir = "/home/linux/yyj/colpali/finetune/pdf2images_all_splits"
...
processor = ColQwen2Processor.from_pretrained(model_dir)
...
def collate_fn(examples):
    ...
    batch_queries = processor(text=texts, max_length=120, padding="max_length", truncation=True, return_tensors="pt").to(model.device)
...
training_args = TrainingArguments(
    output_dir="./colpali_city_0622_colpali",
...
trainer.train() 
print("----------------------------Save Model--------------------------")
trainer.save_model("/home/linux/yyj/colpali/finetune/wiky_city_zh_0622_b5_lr2e4_colqwen")  # 包括模型和 tokenizer 等信息
processor.save_pretrained("/home/linux/yyj/colpali/finetune/wiky_city_zh_0622_b5_lr2e4_colqwen")  # 保存预处理器，如 tokenizer + image processor
